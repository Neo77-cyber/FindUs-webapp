...
urlpatterns = [
    ...
    path(
        "register-as-a-craftsman/", register_craftsman, name="register_as_a_craftsman"
    ),
    ...
    path(
        "service/<slug:service_slug>/submit-review/",
        submit_review,
        name="submit_review",
    ),
    # ============== CRAFTSMAN ROUTES ==============
    ...
    path(
        "check-boost-status/<int:service_id>/",
        check_boost_status,
        name="check_boost_status",
    ),
    # ============== PWA ROUTES ==============
