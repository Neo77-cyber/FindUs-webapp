...
urlpatterns = [
    ...
    path('register-as-a-craftsman/', views.register_craftsman, name='register_as_a_craftsman'),
    ...
    path('service/<int:service_id>/create-review/', views.create_review, name='create_review'),
    path('service/<int:service_id>/submit-review/', views.submit_review, name='submit_review'),
