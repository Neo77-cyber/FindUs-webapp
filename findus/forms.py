    ...
    def clean_phone(self):
        ...
        if phone:
            ...
            if not re.match(r'^(\+39)?[0-9]{9,13}$', phone):
                raise ValidationError("Enter valid Italian phone number (e.g., +39 1234567890)")
...
class CraftsmanSignUpForm(UserCreationForm):
    ...
    years_of_experience = forms.ChoiceField(choices=CraftsmanProfile._meta.get_field('years_of_experience').choices, required=True)
