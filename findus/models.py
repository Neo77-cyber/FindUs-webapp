...
class BoostRequest(models.Model):
    ...
    service = models.ForeignKey(Service, on_delete=models.CASCADE, related_name='boost_requests')
...
class WaitingList(models.Model):
    ...
    category = models.CharField(max_length=50, choices=Service.CATEGORY_CHOICES, blank=True, null=True)
